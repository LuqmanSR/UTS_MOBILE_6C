package id.rdev.Luqman180900756C.network

import id.rdev.Luqman180900756C.activity.data_barang.data.ResultDataBarang
import id.rdev.Luqman180900756C.activity.login.data.ResultLogin
import id.rdev.Luqman180900756C.activity.penjualan.data.ResultKeranjang
import id.rdev.Luqman180900756C.activity.penjualan.data.ResultSearchBarang
import id.rdev.Luqman180900756C.activity.report.detail.data.ResultItemKeranjang
